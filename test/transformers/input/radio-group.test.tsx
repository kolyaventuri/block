...
test('transforms a basic RadioGroup block', () => {
  ...
  const res = transformer(<RadioGroup actionId="aid">
    {option}
    {option2}
  </RadioGroup>);
...
test('can have an initial option', () => {
  ...
  const res = transformer(<RadioGroup actionId="aid" initialOption={option2}>
    {option}
    {option2}
  </RadioGroup>);
...
test('can have a confirmation', () => {
  ...
  const res = transformer(<RadioGroup actionId="aid" confirm={confirmation}>
    {option}
    {option2}
  </RadioGroup>);
